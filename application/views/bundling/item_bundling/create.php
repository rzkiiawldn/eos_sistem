              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="item_bundling_code" name="item_bundling_code" value="<?= set_value('item_bundling_code'); ?>">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="number" min="1" class="form-control" aria-describedby="basic-addon1" name="total_price" value="<?= set_value('total_price'); ?>">
                    </div>
