          ...
          <div class="card card-info shadow">
            ...
            <div class="card-body">
              ...
              <?php if (!empty($this->uri->segment(5))) { ?>
                <form action="<?= base_url('bundling/item_bundling/add_item/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" method="post">
                <?php } else { ?>
                      ...
                      <tbody>
                        ...
                        foreach ($item_bundling_detail as $row) : ?>
                          <tr>
                            ...
                            <td>
                              <?php if (!empty($this->uri->segment(5))) { ?>
                                <form action="<?= base_url('bundling/item_bundling/delete_item_satuann/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $row['id_item_bundling_detail']); ?>" method="post">
                  ...
                  <?php if (!empty($this->uri->segment(5))) { ?>
                    <a href="<?= base_url('bundling/item_bundling/index/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-danger float-right mt-3">Finish</a>
                  <?php } else { ?>
